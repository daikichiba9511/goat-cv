...
|-------|--------|----------|-------------|
| 11 | Complete workflow status transitions | [Issues #34](https://github.com/daikichiba9511/goat-cv/issues/34), [#35](https://github.com/daikichiba9511/goat-cv/issues/35), [#36](https://github.com/daikichiba9511/goat-cv/issues/36) | Guarded APIs, Annotator controls, and focused contract tests built on the persisted state machine |
...
- Completed [Issue #15](https://github.com/daikichiba9511/goat-cv/issues/15) defines the behavior, and completed [Issue #33](https://github.com/daikichiba9511/goat-cv/issues/33) provides the persisted state machine used in order by [#34](https://github.com/daikichiba9511/goat-cv/issues/34), [#35](https://github.com/daikichiba9511/goat-cv/issues/35), and [#36](https://github.com/daikichiba9511/goat-cv/issues/36).
